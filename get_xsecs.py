...
def gest_dsigmadE_table():
    ...
    for j in range(len(projectile_kinetic_energy)):
        ...
        count = count + 151
    pp_i = RegularGridInterpolator(points, pp_xsec)
    pHe_i = RegularGridInterpolator(points, pHe_xsec)
    Hep_i = RegularGridInterpolator(points, Hep_xsec)
    HeHe_i = RegularGridInterpolator(points, HeHe_xsec)
...
def test_apxsec():
    ...
    dsdE_pp, dsdE_phe, dsdE_hep, dsdE_hehe = gest_dsigmadE_pos()
    ...
    dsdE_pp, dsdE_phe, dsdE_hep, dsdE_hehe = gest_dsigmadE_table()
